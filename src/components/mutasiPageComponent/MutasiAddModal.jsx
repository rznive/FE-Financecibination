...
/**
 * MutasiAddModal – Modal wrapper for adding a new Pemasukan or Pengeluaran.
 *
 * @param {object}   props
 * @param {string}   props.mutationType - "masuk" | "keluar"
 * @param {function} props.onClose      - Handler to close the modal
 * @param {function} props.onSuccess    - Handler called after successful submission
 */
export default function MutasiAddModal({ mutationType, onClose, onSuccess }) {
  return (
